...
// 高德开发者key
let key = '694cfcf93b2ddc2bfae3556f3f30c2b9';
...
class Amap {
  ...
  static getPoiAround1(querykeywords = '',location='') {
    return new Promise((resolve, reject) => myAmapFun.getPoiAround({ querykeywords,location, success: resolve, fail: reject }));
  }
